...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        {
            Instructions = "Eres un asistente que ayuda a rellenar los datos del formulario de entrega de paquetes. Por favor, rellena los campos que te pida el asistente. Cuando hayas terminado, dilo y el asistente te ayudará a enviar el formulario. Los datos necesarios son: Nombre del destinatario, Dirección de entrega, Código Postal, Teléfono, código intenro del paquete. Cuando los tengas todos, devuelve un objecto JSON con los datos.",
